...
void onEnable(SEngine* engine) {
	...
	int starGenLocationX = -3000;
	int starGenLocationY = -3000;
	int starGenWidth = 6000;
	int starGenHeight = 12000;

	int smallStars = 60000;
	int mediumStars = 11000;
	int largeStars = 4000;
	...
	for (int i = 0; i < 100; i++) {
		std::stringstream stm;
		stm << "performance_" << i;
		GameObject* performance = new GameObject(0, 0, 0, stm.str());
		Image performanceImage(&cMap);
		performanceImage.addLine("RRRRRGGGGGBBBBBRRRRRGGGGGBBBBBRRRRRGGGGGBBBBBRRRRRGGGGGBBBBBRRRRRGGGGGBBBBBRRRRRGGGGGBBBBB");
		performanceImage.addLine("RRRRRGGGGGBBBBBRRRRRGGGGGBBBBBRRRRRGGGGGBBBBBRRRRRGGGGGBBBBBRRRRRGGGGGBBBBBRRRRRGGGGGBBBBB");
		performanceImage.addLine("RRRRRGGGGGBBBBBRRRRRGGGGGBBBBBRRRRRGGGGGBBBBBRRRRRGGGGGBBBBBRRRRRGGGGGBBBBBRRRRRGGGGGBBBBB");
		performanceImage.addLine("RRRRRGGGGGBBBBBRRRRRGGGGGBBBBBRRRRRGGGGGBBBBBRRRRRGGGGGBBBBBRRRRRGGGGGBBBBBRRRRRGGGGGBBBBB");
		performanceImage.addLine("RRRRRGGGGGBBBBBRRRRRGGGGGBBBBBRRRRRGGGGGBBBBBRRRRRGGGGGBBBBBRRRRRGGGGGBBBBBRRRRRGGGGGBBBBB");
